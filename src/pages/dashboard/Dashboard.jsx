...
const Dashboard = () => {
  ...
  const statCards = [
    { label: "Total Archived", value: stats.totalArchived, icon: Archive, colorClass: { bg: 'bg-primary/10', text: 'text-blue-400' } },
    ...
    { label: "Views", value: stats.totalViews, icon: Eye, colorClass: { bg: 'bg-primary/80/10', text: 'text-purple-400' } },
  ];
